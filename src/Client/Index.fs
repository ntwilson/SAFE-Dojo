            ...
            prop.children [
              Bulma.control.div [
                ...
                prop.children [
                  ...
                  Bulma.icon [ icon.isLeft; prop.children [ Html.i [ prop.className "fas fa-home" ] ] ]
                  match model.ValidationError with
                  | Some _ -> Bulma.icon [ icon.isRight; prop.children [ Html.i [ prop.className "fas fa-times" ] ] ]
                  | None -> Bulma.icon [ icon.isRight; prop.children [ Html.i [ prop.className "fas fa-check" ] ] ]
                  Bulma.help [
